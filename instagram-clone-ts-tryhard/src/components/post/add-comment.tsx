...
export default function AddComment({ docId, comments, setComments, commentInput }: any) {
    ...
    const handleSubmitComment = (event: React.FormEvent<HTMLFormElement> | any) => {
        ...
        return firebase
            ...
            .doc(docId)
            .update({
                comments: firestore.arrayUnion({ displayName, comment })
            });
    }
